        ...
        <nav className="w-full px-3 sm:px-5 lg:px-8">
          <div className="flex h-16 lg:h-20 items-center justify-between">
            ...
            <div className="flex items-center">
              ...
              >
                {isMenuOpen ? <X className="h-7 w-7 stroke-[1.5]" /> : <Menu className="h-7 w-7 stroke-[1.5]" />}
              </button>
            </div>
          </div>
        </nav>
        ...
        {isMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-y-0 left-0 w-[280px] z-50 bg-[#FCF5E2] border-r border-border lg:hidden"
            >
