...
const products = [
  ...
  },
  {
    ...
    hoverImage: "/premium-leather-material-sustainable-luxury.jpg",
  ...
  return (
    <section className="py-24 lg:py-32 px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="font-serif text-3xl lg:text-5xl mb-4 text-[#2B1608]">Featured Artworks</h2>
        ...
        >
          {artServices.map((item) => (
            <span
              key={item}
              className="border border-[#2B1608]/60 px-4 py-2 text-[11px] sm:text-xs tracking-[0.15em] uppercase text-[#2B1608]/80"
            >
              {item}
            </span>
          ))}
        ...
        >
          <Link
            href="/shop"
            className="inline-flex items-center justify-center border border-[#2B1608] bg-[#2B1608] text-background px-8 py-4 text-sm tracking-[0.2em] uppercase hover:bg-transparent hover:text-[#2B1608] transition-colors duration-300"
          >
